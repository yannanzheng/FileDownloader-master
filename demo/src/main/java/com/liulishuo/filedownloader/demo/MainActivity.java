...
import com.liulishuo.filedownloader.demo.tasks.manage.TasksManagerDemoActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickMultitask(final View view) {//多任务
        startActivity(new Intent(this, MultitaskTestActivity.class));
    }

    public void onClickSingle(final View view) {//单任务
        startActivity(new Intent(this, SingleTaskTestActivity.class));
    }

    public void onClickHybridTest(final View view) {//混合测试
        startActivity(new Intent(this, HybridTestActivity.class));
    }

    public void onClickTasksManager(final View view) {//任务管理
    ...
    public void onClickNotification(final View view){//通知
    ...
    protected void onDestroy() {
        ...
        FileDownloadMonitor.releaseGlobalMonitor();//释放全局监控
    }
}
